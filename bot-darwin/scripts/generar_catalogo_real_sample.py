...
def main():
    ...
    lineas.append(" *")
    lineas.append(" * NO ESTÁ COMITEADO A GIT (ver .gitignore) — instrucción explícita del")
    lineas.append(" * usuario de no subir datos reales de negocios todavía. Vive solo en el")
    lineas.append(" * checkout de esta sesión; si se pierde, se regenera desde el CSV.")
    lineas.append(" */")
    lineas.append("(() => {")
